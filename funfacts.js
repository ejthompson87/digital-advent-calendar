module.exports = function calendarCalc(currentDate, chocCookieArray, chocCookieBittenArray) {
    ...
    var day4 = createDate(4, "Every color of froot loop is the same flavour.", chocs.star, chocs.starb2);
    var day5 = createDate(5, "In Denmark, if you are unmarried at 25, you'll get cinnamon thrown all over you on your birthday.", chocs.holly, chocs.hollyb1);
    ...
    var day9 = createDate(9, "If NASA sent birds into space they would soon die; they need gravity to swallow.", chocs.tree, chocs.treeb2);
    ...
    var day11 = createDate(11, "Certain frogs can be frozen solid, then thawed, and survive.", chocs.cc, chocs.ccb2);
    var day12 = createDate(12, "To escape the grip of a crocodile's jaws, push your thumbs into its eyeballs - it will let you go instantly.", chocs.holly, chocs.hollyb2);
    ...
    var day15 = createDate(15, "Google 'Do a barrel roll' and watch your results do a barrel roll.", chocs.star, chocs.starb1);
    ...
    var day21 = createDate(21, "About 8,000 Americans are injured by musical instruments each year.", chocs.tree, chocs.treeb1);
    var day22 = createDate(22, "There are more fake flamingos in the world than real ones.", chocs.holly, chocs.hollyb2);
    var day23 = createDate(23, "France was still executing people by guillotine when Star Wars: A New Hope hit theatres.", chocs.cc, chocs.ccb1);
